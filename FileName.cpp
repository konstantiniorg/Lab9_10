/*Variant 8.
Opredelit strukturnyj tip, opisyvayushchij kompyuternye igry(nazvanie igry,
    studiya razrabotchik, stoimost podpiski, ob"em auditorii igrokov,
    podderzhivaemye platformy : PC, mobile, gamepad; tip: RPG, strategiya, gonki,
    aviasimulyator i dr.).Zapolnit strukturnyj massiv 20 - yu zapisyami.Perepisat iz
    iskhodnogo massiva v drugoj massiv, informaciyu tolko o shuterah ot id Software.
    Zatem novyj massiv otsortirovat po ob"emu auditorii.Vyvesti vse dannye po
    konkretnoj igre.Vyvesti 4 samyh nedorogih igr.Realizovat funkciyu izmeneniya
    igry.V otdelnyj massiv pomestit vse mobilnye igry, v kotoryh mozhno
    pogonyat.Realizovat vyvod otfiltrovannyh dannyh v vide obertochnoj funkcii.*/
...
int main() {
    ...
    readAudienceFromTextFile("audience.txt", games, 20);
